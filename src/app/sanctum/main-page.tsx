...
// ── Constants ──────────────────────────────────────────────────────────────────
const INACTIVITY_MS = 180_000; // 60 seconds
...
export default function SanctumPage() {
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-[#0B0E14] w-full relative">
        ...
        {!session ? (
          ...
          <>
            {/* ── Unlocked content ── */}
            <div className="px-4 sm:px-8 py-8 mt-10 md:mt-0">
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <h1 className="text-3xl font-bold text-[#E2E8F0]">Sanctum</h1>
                    <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold uppercase
              ...
              <p className="text-[#94A3B8] text-sm mb-8 ml-12">
                End-to-end encrypted. Titles and content are decrypted only on your device.
              </p>
