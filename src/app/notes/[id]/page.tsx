...
const NoteDetailPage: React.FC = () => {
  ...
  // const startEditing = () => {
  //   setIsEditing(true);
  //   if (contentRef.current && note) contentRef.current.innerHTML = note.content;
  ...
  // Runs after React has rendered and attached contentRef
  ...
  // const cancelEdit = () => {
  //   if (contentRef.current && note) contentRef.current.innerHTML = note.content;
  //   setIsEditing(false); setShowColors(false);
  // };

  const cancelEdit = () => {
  // Don't touch innerHTML — just flip state.
  // The useEffect will re-initialize if editing starts again.
  setIsEditing(false);
  setShowColors(false);
};
  ...
  return (
    <div className="flex flex-col h-screen" style={{ background: 'var(--bg)' }}>
      ...
      {/* ── Edit toolbar (only in editing mode) ── */}
      {isEditing && (
            ...
            <div>
              ...
              {/* <div className="mt-12 pt-6 flex justify-center"
                ...
                <button onClick={startEditing}
                  ...
                  style={{ background: `linear-gradient(135deg, ${color}, ${color}bb)`, boxShadow: `0 0 18px -4px ${color}60` }}>
      ...
      {/* Shared editor + note body styles */}
      <style>{`
