...
import { MoreVertical, Edit2, Trash2, Archive, ExternalLink } from 'lucide-react';
...
export default function ProjectCard({ project, onEdit, onDelete, onArchive }: ProjectCardProps) {
  ...
  return (
    <div className="group relative bg-[#151922] border border-white/10 rounded-2xl overflow-hidden
      hover:border-[#2e5bff]/40 transition-all duration-300 hover:shadow-[0_0_20px_-5px_rgba(46,91,255,0.25)]
      flex flex-col">
          ...
          <div className="relative" onClick={stopProp}>
            ...
            {menuOpen && (
              <>
                ...
                />
                <div className="absolute right-0 bottom-full mb-1 w-44 bg-[#151922] border border-white/10
